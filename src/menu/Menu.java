...
public class Menu {
    ...
    private final AutorService servAut;
    private final EditorialService servEdit;
    private final LibroService servLibro;

    public Menu() {
        sc = new Scanner(System.in, "ISO-8859-1").useDelimiter("\n");
        servAut = new AutorService();
        servEdit = new EditorialService();
        servLibro = new LibroService();
    }
